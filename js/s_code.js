...
var s_account= mckinseyfirmsecurity-dev
...
s.Media.trackVars="events,prop6,eVar1,eVar2,eVar3,eVar4,eVar5, eVar6";
s.Media.trackEvents="event1,event2,event3,event4,event5,event6,event7,event8,event9,event10,event11,event12,event13,event14";
...
s.Media.contextDataMapping = {
  "a.media.name":"eVar1,prop6",
  "a.media.segment":"eVar2",
  "a.contentType":"eVar3",
  "a.media.timePlayed":"event14",
  "a.media.view":"event1",
  "a.media.segmentView":"event2",
  "a.media.complete":"event6",
  "a.media.milestones":{
     25:"event3",
     50:"event4",
     75:"event5"
  }//,
  // "a.media.ad.segment":"eVar4",
  // "a.media.ad.pod":"eVar5",
  // "a.media.ad.podPosition":"eVar6",
  // "a.media.ad.CPM":"event11",
  // "a.media.ad.timePlayed":"event7",
  // "a.media.ad.view":"event8",
  // "a.media.ad.segmentView":"event9",
  // "a.media.ad.complete":"event10",
  // "a.media.ad.clicked":"event12",
