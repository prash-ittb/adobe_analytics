...
class DataLayerForm extends ConfigFormBase {
  ...
  public function validateForm(array &$form, FormStateInterface $form_state) {
    ...
    if (Token::scan($form_state->getValue('data_layer_root_field'))) {
      $form_state->setErrorByName('data_layer_root_field', 'Usage of tokens is prohibited for the field');
    }
    elseif (Token::scan($form_state->getValue('data_layer_key'))) {
      $form_state->setErrorByName('data_layer_key', 'Usage of tokens is prohibited for the field');
    }
